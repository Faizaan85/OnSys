                        ...
                        <div class="col-md-12">
                            <!-- general form elements -->
                             <h2 class="page-header" align="right">
								...
								{
									?>
                                    <a href="<?php echo base_url().'customer/manageCustomer/?page='.$page?>" class="btn btn-success"><i class="glyphicon glyphicon-arrow-left"></i></a>
                                    <?php
								}
								else
								{
									?>
                                    <a href="<?php echo base_url().'customer/manageCustomer'?>" class="btn btn-success"><i class="glyphicon glyphicon-arrow-left"></i></a>
                                    <?php
								}
								?>
                             </h2>
                                ...
                                <form role="form" name="frm" class="form-horizontal" id="frm" enctype="multipart/form-data" method="post" action="<?php echo current_url().$url?>">
                                	<div class="box-body">
                                             <div class="form-group">
                                                <label for="inputEmail3" class="col-sm-3 control-label">Customer Code:<span class="text-error"><b>*</b></span></label>
                                                 <?php echo form_error('ccode' ,'<div class="text-error">','</div>'); ?>
                                                 <div class="col-sm-4">
                                                    <input type="text" name="ccode" id="ccode" class="form-control" placeholder="Enter Customer Code" style="text-transform:uppercase"  value="<?php echo set_value('ccode',$ccode);?>" <?php if($ccode!='' && $customer_id!=''){ ?> readonly="readonly" <?php } ?> required autofocus>
                                                 </div>
                                             </div>
											 <div class="form-group">
                                                <label for="inputEmail3" class="col-sm-3 control-label">Company Name:<span class="text-error"><b>*</b></span></label>
                                                 ...
                                                 <div class="col-sm-4">
                                                    <input type="text" name="cname" id="cname" class="form-control" placeholder="Enter Company Name" style="text-transform:uppercase" value="<?php echo set_value('cname',$cname);?>" required autofocus>
                                                 </div>
                                             </div>
											 <div class="form-group">
                                                <label for="inputEmail3" class="col-sm-3 control-label">EmailId:<span class="text-error"><b>*</b></span></label>
                                                 ...
                                                 <div class="col-sm-4">
                                                    <input type="text" name="cemail" id="cemail" class="form-control" placeholder="Enter Customer EmailId" style="text-transform:uppercase" value="<?php echo set_value('cemail',$cemail);?>" required autofocus>
                                                 </div>
                                             </div>
											 <div class="form-group">
                                                <label for="inputEmail3" class="col-sm-3 control-label">Address:<span class="text-error"><b>*</b></span></label>
                                                 ...
                                                 <div class="col-sm-4">
													   <textarea name="caddress" style="text-transform:uppercase" id="caddress" cols="53" rows="6"><?php echo set_value('caddress',$caddress);?></textarea>
                                                 </div>
                                             </div>
											 <div class="form-group">
											 ...
											 <div class="form-group">
                                                <label for="inputEmail3" class="col-sm-3 control-label">Fax Number:</label>
                                                 ...
                                                 <div class="col-sm-4">
                                                    <input type="text" name="cfax" id="cfax" class="form-control" style="text-transform:uppercase" placeholder="Enter Fax Number"  value="<?php echo set_value('cfax',$cfax);?>"  autofocus>
                                                 </div>
                                             </div>
											 <div class="form-group">
											 ...
											 <div class="form-group">
                                                <label for="inputEmail3" class="col-sm-3 control-label">Credit Limit:<span class="text-error"><b>*</b></span></label>
                                                 ...
                                                 <div class="col-sm-4">
                                                    <input type="text" name="climit" id="climit" class="form-control" placeholder="Enter Customer Credit Limit"  value="<?php echo set_value('climit',$climit);?>"  <?php if(!empty($climit)){ ?> readonly="readonly" <?php } ?>  autofocus>
                                                 </div>
                                             </div>
											 <div class="form-group">
											 ...
											 <div class="form-group">
                                                <label for="inputEmail3" class="col-sm-3 control-label">Customer Balance:</label>
                                                 <?php echo form_error('cbalance' ,'<div class="text-error">','</div>'); ?>
                                                 <div class="col-sm-4">
                                                    <input type="text" name="cbalance" id="cbalance" class="form-control" placeholder="Enter Customer Balance"  value="<?php echo set_value('cbalance',$cbalance);?>" <?php if(!empty($cbalance)){ ?> readonly="readonly" <?php } ?> autofocus>
                                                 </div>
                                             </div>			 
											 
											 <div class="form-group">
                                                <label for="inputEmail" class="col-sm-3 control-label">Customer Status:<span class="text-error"><b>*</b></span></label>
                                            ...
                                            <div class="box-footer">
												  ...
												  <a href="<?php echo base_url().'customer/manageCustomer'?>" class="btn btn-primary">Cancel</a>
                                            </div>
                                     </div>
                                </form>
                            </div><!-- /.box -->
...
$(document).ready(function()
{
	$("#frm").validate(
	{
		...
		messages:
		{
		        ccode:"<div class='text-error'>Please Enter Customer Code</div>",
			...
			cbilltype:"<div class='text-error'>Please Select Customer Bill Type</div>",
			caddress:"<div class='text-error'>Please Enter Customer Address</div>",
			climit:"<div class='text-error'>Please Enter Customer Limit</div>",
			cstatus:"<div class='text-error'>Please Select Customer Status </div>"
		}
	});
});
</script>