	...
	<div class="content-wrapper">
              ...
              <section class="content">
                  ...
                  <?php 
					  ...
					  <h2 class="page-header" align="right"><a href="<?php echo base_url().'customer/addCustomer' ?>" class="btn btn-success">Add Customer</a></h2>
                      <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                            <?php echo form_open(base_url().'customer/manageCustomer');	?>	
                                <div class="box-header">
                                    <h3 class="box-title">Manage Customer</h3>
                                    <div class="box-tools">
                                        <div class="input-group">
                                            <input type="text" name="filter_name" class="form-control input-sm pull-right" style="width: 200px;" placeholder="Search Customer" value="<?php echo $filter_name ?>" />
                                ...
                                <div class="box-body table-responsive no-padding">
                                    <table class="table table-hover table-bordered table-striped">
                                        <tr>
                                            <th><a href="<?php echo $order_url; ?>">Customer Id</a></th>
                                            <th>Company Name</th>
                                            <th>Customer Code</th>
											<th>Customer Contact Person</th>
											<th>Customer Bill Type</th>
											<th>Status</th>
                                            <th>Date Added</th>
                                            <th>Action</th>
                                        </tr>
