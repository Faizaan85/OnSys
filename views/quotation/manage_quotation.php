	...
	<div class="content-wrapper">
              ...
              <section class="content">
                  ...
                  <?php 
					  ...
					  <h2 class="page-header" align="right"><a href="<?php echo base_url().'quotation/addQuotation' ?>" class="btn btn-success">Add Quotation</a></h2>
                      <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                            <?php echo form_open(base_url().'quotation/manageQuotation');	?>	
                                <div class="box-header">
                                    <h3 class="box-title">Manage Quotation</h3>
                                    <div class="box-tools">
                                ...
                                <div class="box-body table-responsive no-padding">
                                    <table class="table table-hover table-bordered table-striped">
                                        <tr>
                                            <th><a href="<?php echo $order_url; ?>">Quotation Id</a></th>
                                            <th>Quotation Code</th>
                                            <th>Customer Name</th>
											<th>Invoice Code</th>
											<th>Quotation LPO Number</th>
											<th>Download</th>
                                            <th>Date Added</th>
                                         ...
                                         <?php
										  ...
										  if(! empty($results))
										  {
											  foreach($results as $player)
											  {
											  	?>
                                                <tr>
                                                    <td><?php echo $player['quotation_id'] ?></td>
                                                    <td><?php echo $player['quotation_code'] ?></td>
                                                    <td><?php echo $player['customer_name'] ?></td>
													<td><?php echo $player['quotation_invoicecode'] ?></td>
													<td><?php echo $player['quotation_lpo_number'] ?></td>
													<td><a href="<?php echo $player['quotation_link'];?>" class="btn btn-success" target="_blank">Download PDF</a></td>
													...
													?>   
													<td><a href="<?php echo $player['edit_url']?>" class="btn btn-default btn-circle" id="update"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;<a href="<?php echo $player['delete_url']?>" onClick="return confirm('Are you sure to Delete this Quotation Record?');" class="btn btn-default btn-circle" id="delete"><i class="fa fa-times"></i></a></td>
  												</tr>
                                              <?php
											  }
										  } 
